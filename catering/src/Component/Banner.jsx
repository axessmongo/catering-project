  ...
  return (
    <div>
      <section className="nav-banner">
        <nav class="navbar navbar-expand-lg nav-banner fixed-top bg-body-tertiary" id="home">
          <div class="container-fluid ">
            <a
              class="navbar-brand headlogo"
              href="#"
      ...
      {/* end */}
        ...
        <section className="container mt-5"id="offering" >
          <h1 className="text-center heading1 fw-semibold text-capitalize" data-aos="fade-down">
            The best offering catering services
          </h1>
          <div className="row mt-5"  data-aos="zoom-in-down" data-aos-duration="700">
            <div className="col-lg-6  ">
              <h2 className="mx-3 text-danger heading2 text-center">Wedding Catering</h2>
          ...
          <div className="row mt-5"  data-aos="zoom-out-down" data-aos-duration="600">
            <div className="col-lg-6">
            ...
            <div className="row mt-5"  data-aos="fade-up" data-aos-duration="900">
              <div className="col-lg-6 ">
                ...
                <p className="mx-3 heading5">
                  As a premium and award-winning catering service, Kasikannu
                  Catering World takes pride in being exceeding expectations and
                  achieving customer delight. With over 1000+ happy customers
                  and experience in events all over Tamil Nadu, we have achieved
                  an unmatched reputation for our service excellence and
                  culinary delights.
                </p>
              </div>
              <div className="col-lg-6">
        ...
        <section className=" container mt-5 " >
          <h2 className="text-center fw-semibold heading1" data-aos-duration="1500" data-aos="fade-down">
          ...
          <p className="text-center heading5 pt-4" style={{ color: "gray" }}>
            ...
            services. Our meals are cooked to perfection. Customers commended
            the food's flavour, nutritional content, and price.
          </p>
          <div className="row"  data-aos="fade-left"  data-aos-duration="2000">
            <div className="col-md-4">
              <div class="card">
                ...
                <p className="pt-3 heading5 text-center">
                  We are make sure that the food we provide is nutritious as
                  well as tasty
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div class="card">
                ...
                <p className="pt-3 heading5 text-center">
                  The most important component of any celebration or gathering
                  is cuisine and you may have delicious means essentially by
                  hiring an experienced chef.
                </p>
              </div>
            </div>
          </div>
          <div className="row pt-5" data-aos="fade-right" data-aos-duration="2000" >
            <div className="col-md-4">
              <div class="card">
                <h5>Belief</h5>
                <img className="card-img" src={belief} alt="" />
                <p className="pt-3 heading5 text-center">
                  We are committed to providing high quality Catering services
                  to our customer.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div class="card">
                ...
                <p className="pt-3 heading5 text-center">
                  The timely delivery of ordered food is one of the most
                  critical parts of a caterer-customer relationship.
                </p>
              </div>
            </div>
            <div className="col-md-4">
            ...
            <div className="row" data-aos="zoom-in" data-aos-duration="1200" >
              <div className="col-lg-6 ">
                ...
                <div className="mt-5">
                  ...
                  <p>
                    We have bets in class infrastructure and a central kitchen
                    of over 10,000+ sq feet
                  </p>
                </div>
                <div className="mt-5">
                  <h3>
                  ...
                  <p>
                    We have over 100 employees and 17 master chefs who can
                    prepare any cuisine and satisfy your requirements.
                  </p>
                </div>
              </div>
              <div className="col-lg-6 ">
        ...
        <section className=" container" id="categories">
          <h1 className="text-center mt-3" data-aos="fade-down">Catering Service Categories</h1>
     ...
     data-aos-duration="1500">
          ...
          <div className="row justify-content-around" data-aos="fade-left"
     data-aos-easing="linear"
     data-aos-duration="1500">
            <div className="col-md-3 d-flex flex-column align-items-center justify-content-center  ">
              <div className="circle" id="cate-card">
          ...
          <div className="row py-3 my-3 text-light">
            ...
            <div className="col-md-4 d-flex justify-content-center align-items-center">
              <div className="text-center">
                ...
                <div className=" pt-4">
                <p> No:34, Tidel Park, Taramani, Chennai - 600 056.
Tamilnadu, India</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 d-flex justify-content-center align-items-center">
              <div className="text-center">
                ...
                <div className=" pt-4">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam, fugiat ea atque reiciendis.</p>
                </div>
              </div>
            </div>
          </div>
